...
main() {
  echo -e "\n${BOLD}${CYAN}╔════════════════════════════════════════════════════╗"
  echo -e "║  lowakernel-zen5 — AMD ThinkPad Kernel Builder      ║"
  ...
  success "lowakernel-zen5 installed!"
  echo -e "  UKI:  /boot/EFI/Linux/${KERNEL_NAME}.efi"
  echo -e "  Log:  $BUILD_DIR/build-zen5.log"
  echo -e "  ${CYAN}Reboot and select lowakernel-zen5${NC}"
  echo -e "${BOLD}${GREEN}════════════════════════════════════════${NC}"
}
